	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(UserData, { username: this.props.params.username, bio: this.state.bio })
	      ),
	      React.createElement(
	        'div',
	        { className: 'col-sm-4' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Notes = React.createClass({
	  ...
	  handleNoteSubmit: function handleNoteSubmit(note) {
	...
	var NoteForm = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement('textarea', { value: this.state.note, onChange: this.handleNoteChange }),
